...
static int vqec_vision_ai_qcom_dvwir_capabilities_valid(
    ...
    return _capabilities != NULL && _capabilities->operations_mask != 0 &&
           (_capabilities->operations_mask & ~((uint32_t)VQEC_VISION_AI_DSP_V1_ALL_OPERATIONS)) ==
               0 &&
           _capabilities->max_descriptor_bytes >= VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES &&
...
vqec_vision_ai_dsp_v1_wire_status vqec_vision_ai_qcom_dvwir_encode_capabilities(
    ...
    if (_wire == NULL || _wire_bytes != VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES ||
    ...
    vqec_vision_ai_qcom_dvwir_write_u16(_wire + VQEC_VISION_AI_DSP_V1_KIND_OFFSET,
                                        VQEC_VISION_AI_DSP_V1_SYNC_COMPLETION);
    ...
    vqec_vision_ai_qcom_dvwir_write_u32(_wire + VQEC_VISION_AI_DSP_V1_FIELD_24_OFFSET,
                                        _capabilities->max_output_bytes);
    vqec_vision_ai_qcom_dvwir_write_u32(_wire + VQEC_VISION_AI_DSP_V1_FIELD_28_OFFSET,
...
vqec_vision_ai_qcom_dvwir_decode_capabilities(const uint8_t* _wire, size_t _wire_bytes,
    ...
    if (_wire == NULL || _capabilities == NULL ||
        _wire_bytes != VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES) {
        return vqec_vision_ai_dsp_v1_wire_malformed;
    }
    ...
    if (vqec_vision_ai_qcom_dvwir_read_u16(_wire + VQEC_VISION_AI_DSP_V1_KIND_OFFSET) !=
        VQEC_VISION_AI_DSP_V1_SYNC_COMPLETION) {
        return vqec_vision_ai_dsp_v1_wire_unsupported;
    }
    vqec_vision_ai_dsp_v1_capabilities decoded;
    ...
    decoded.max_output_bytes =
        vqec_vision_ai_qcom_dvwir_read_u32(_wire + VQEC_VISION_AI_DSP_V1_FIELD_24_OFFSET);
    decoded.domain_generation =
        vqec_vision_ai_qcom_dvwir_read_u32(_wire + VQEC_VISION_AI_DSP_V1_FIELD_28_OFFSET);
...
vqec_vision_ai_qcom_dvwir_encode_request(const vqec_vision_ai_dsp_v1_request* _request,
    ...
    if (_request == NULL || _descriptor == NULL ||
        ...
        _request->descriptor_bytes < VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES ||
    ...
    memcpy(_descriptor, g_vqec_vision_ai_dsp_v1_magic, sizeof(g_vqec_vision_ai_dsp_v1_magic));
    vqec_vision_ai_qcom_dvwir_write_u16(_descriptor + VQEC_VISION_AI_DSP_V1_MAJOR_OFFSET,
                                        VQEC_VISION_AI_DSP_V1_MAJOR);
    vqec_vision_ai_qcom_dvwir_write_u16(_descriptor + VQEC_VISION_AI_DSP_V1_MINOR_OFFSET,
                                        VQEC_VISION_AI_DSP_V1_MINOR);
    vqec_vision_ai_qcom_dvwir_write_u16(_descriptor + VQEC_VISION_AI_DSP_V1_HEADER_BYTES_OFFSET,
                                        VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES);
    vqec_vision_ai_qcom_dvwir_write_u16(_descriptor + VQEC_VISION_AI_DSP_V1_KIND_OFFSET,
                                        _request->operation);
    vqec_vision_ai_qcom_dvwir_write_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_12_OFFSET,
                                        _request->descriptor_bytes);
    vqec_vision_ai_qcom_dvwir_write_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_16_OFFSET,
                                        _request->input_bytes);
    vqec_vision_ai_qcom_dvwir_write_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_20_OFFSET,
                                        _request->output_capacity_bytes);
    vqec_vision_ai_qcom_dvwir_write_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_24_OFFSET,
                                        _request->domain_generation);
    vqec_vision_ai_qcom_dvwir_write_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_28_OFFSET, 0);
    return vqec_vision_ai_dsp_v1_wire_ok;
}
...
vqec_vision_ai_qcom_dvwir_validate_request(const vqec_vision_ai_dsp_v1_capabilities* _capabilities,
    ...
    if (!vqec_vision_ai_qcom_dvwir_capabilities_valid(_capabilities) || _descriptor == NULL ||
        _request == NULL || _descriptor_bytes < VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES) {
        return vqec_vision_ai_dsp_v1_wire_malformed;
    }
    if (memcmp(_descriptor, g_vqec_vision_ai_dsp_v1_magic, sizeof(g_vqec_vision_ai_dsp_v1_magic)) !=
            0 ||
        vqec_vision_ai_qcom_dvwir_read_u16(_descriptor +
                                           VQEC_VISION_AI_DSP_V1_HEADER_BYTES_OFFSET) !=
            VQEC_VISION_AI_DSP_V1_ENVELOPE_BYTES ||
        vqec_vision_ai_qcom_dvwir_read_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_28_OFFSET) !=
            0) {
        return vqec_vision_ai_dsp_v1_wire_malformed;
    }
    if (vqec_vision_ai_qcom_dvwir_read_u16(_descriptor + VQEC_VISION_AI_DSP_V1_MAJOR_OFFSET) !=
            VQEC_VISION_AI_DSP_V1_MAJOR ||
        vqec_vision_ai_qcom_dvwir_read_u16(_descriptor + VQEC_VISION_AI_DSP_V1_MINOR_OFFSET) !=
            VQEC_VISION_AI_DSP_V1_MINOR) {
        return vqec_vision_ai_dsp_v1_wire_incompatible;
    }
    vqec_vision_ai_dsp_v1_request decoded;
    decoded.operation =
        vqec_vision_ai_qcom_dvwir_read_u16(_descriptor + VQEC_VISION_AI_DSP_V1_KIND_OFFSET);
    decoded.descriptor_bytes =
        vqec_vision_ai_qcom_dvwir_read_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_12_OFFSET);
    decoded.input_bytes =
        vqec_vision_ai_qcom_dvwir_read_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_16_OFFSET);
    decoded.output_capacity_bytes =
        vqec_vision_ai_qcom_dvwir_read_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_20_OFFSET);
    decoded.domain_generation =
        vqec_vision_ai_qcom_dvwir_read_u32(_descriptor + VQEC_VISION_AI_DSP_V1_FIELD_24_OFFSET);
    ...
    if (decoded.domain_generation != _capabilities->domain_generation) {
        return vqec_vision_ai_dsp_v1_wire_stale_generation;
    }
