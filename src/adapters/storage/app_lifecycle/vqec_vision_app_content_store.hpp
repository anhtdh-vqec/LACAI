#ifndef VQEC_VISION_AI_STOR_APP_LIFECYCLE_APP_CONTENT_STORE_HPP
#define VQEC_VISION_AI_STOR_APP_LIFECYCLE_APP_CONTENT_STORE_HPP
...
#endif  // VQEC_VISION_AI_STOR_APP_LIFECYCLE_APP_CONTENT_STORE_HPP
