...
camera_graph_pump now connects an already-started source_lifecycle to a configured,
...
multi_source_supervisor now binds exactly 1..16 already-composed camera_session owners and
