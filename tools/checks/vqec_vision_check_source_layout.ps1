...
$include_roots = @('include', 'src',
    ...
    'src/adapters/qualcomm/qnn', 'src/adapters/fw_output', 'src/adapters/fw_control',
    'src/adapters/fw_control/app_manager', 'src/adapters/fw_control/enrollment',
    'src/adapters/fw_control/usecase', 'src/adapters/security', 'src/adapters/storage',
    'src/adapters/storage/app_lifecycle', 'src/adapters/storage/evidence',
    'src/adapters/storage/identity', 'src/adapters/storage/metadata',
