...
| `src/perception/detection/vqec_vision_model_decoder_registry.cpp` | Bounded activation-time mapping from catalog decoder contracts to non-owning decoder ports | Trusted decoder loading, lifecycle ownership and concrete model implementations |
