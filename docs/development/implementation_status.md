...
| `src/perception/embedding/vqec_vision_exact_embedding_index.cpp` | Neutral revision-pinned embedding index port and bounded exact cosine backend with model-version isolation and CAS mutations | Durable encrypted gallery adapter, FAISS adapter, enrollment and calibrated FR policy |
