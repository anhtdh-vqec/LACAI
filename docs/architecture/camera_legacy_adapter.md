...
The media receiver is separate from the
[Camera control client](camera_control_client.md), now source-delivered with an optional GIO binding.
Neither is yet wired to a combined lifecycle coordinator or hardware submission.
