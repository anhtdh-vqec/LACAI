...
2026-09-11 update: a fresh default (all options OFF) configuration registers 50 tests,
...
JSON loaders, the output-manifest checker and SHA-256 digest, and registers 68 tests,
