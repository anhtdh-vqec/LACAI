...
| Runtime | Acquisition composition, bounded 1..16-source deployment loader and fixed-index activation snapshot | authentication/FW RAW-source resolution, unified multi-source supervisor, cameraai_app entrypoint, preview/inference cadence split, board capability admission and health |
