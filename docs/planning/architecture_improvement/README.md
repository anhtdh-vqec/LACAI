...
| [1C. Activation delta theo ứng dụng](incremental_app_activation_plan.md) | AI APP lead | **Planned**; phải đóng trước usecase product tiếp theo | Snapshot-diff nội bộ, feature delta và model dependency refcount để toggle không restart ứng dụng khác |
