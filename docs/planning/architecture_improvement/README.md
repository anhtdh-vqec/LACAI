...
| [1A. Phân phối ứng dụng usecase](usecase_app_distribution_plan.md) | AI APP lead | **Board-smoke lifecycle 2026-09-20**; full async mutation đã logic-tested, board rerun/backend conformance còn mở | AI-owned D-Bus App Manager, app-as-SKU/shared-runtime, entitlement-gated async lifecycle và installed-only control; backend là peer theo contract AI APP |
| [1B. Product slice khói/lửa và App Manager](fire_smoke_product_slice_plan.md) | AI APP lead | **AI-owned board-smoke đã đóng 2026-09-20**; chưa accepted toàn sản phẩm | Service bootstrap đã tách, S04 đi qua install/update/rollback/config/activation/metadata/reference-evidence; model quality, cold-start và released-FW gates còn mở |
| [1C. Activation delta theo ứng dụng](incremental_app_activation_plan.md) | AI APP lead | **Accepted 2026-09-20**; S04 + shared-model fixture, 172/172 eSDK và QCS6490 gate | Snapshot-diff nội bộ, transactional feature delta, dependency refcount và async quiesce barrier; usecase product mới vẫn cần quality/resource gate riêng |
