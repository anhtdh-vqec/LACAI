...
![Tests](https://img.shields.io/badge/logic%20tests-80%20passing%20(QEMU)-green)
...
**Bằng chứng logic:** cấu hình default (mọi option OFF) **61/61** test và cấu hình mở rộng
(Camera, GIO D-Bus, GStreamer bridge, Qualcomm, JSON, digest, QNN engine) **80/80** test
