...
![Tests](https://img.shields.io/badge/logic%20tests-75%20passing%20(QEMU)-green)
...
**Bằng chứng logic:** cấu hình default (mọi option OFF) **57/57** test và cấu hình mở rộng
(Camera, GIO D-Bus, GStreamer bridge, Qualcomm, JSON, digest, QNN engine) **75/75** test
