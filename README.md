...
![Tests](https://img.shields.io/badge/logic%20tests-79%20passing%20(QEMU)-green)
...
**Bằng chứng logic:** cấu hình default (mọi option OFF) **60/60** test và cấu hình mở rộng
(Camera, GIO D-Bus, GStreamer bridge, Qualcomm, JSON, digest, QNN engine) **79/79** test
