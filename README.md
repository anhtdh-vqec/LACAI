...
![Tests](https://img.shields.io/badge/logic%20tests-88%20passing%20(QEMU)-green)
...
**Bằng chứng logic:** cấu hình default (mọi option OFF) **69/69** test và cấu hình mở rộng
(Camera, GIO D-Bus, GStreamer bridge, Qualcomm, JSON, digest, QNN engine) **88/88** test
